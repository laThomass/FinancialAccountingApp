 ...
 * Implements the IStock interface, and allows multiple stocks to be added.
 */
...
public class Stock implements IStock {
  ...
  public static double viewGainLoss(String symbol, String startDateStr,
                                    String endDateStr, IAlphaAPIInterface api,
                                    Map<String, List<Stock>> library) throws IOException {
  ...
  public static double viewXDayMovingAverage(String symbol, String dateStr, int days,
                                             IAlphaAPIInterface api, Map<String,
          List<Stock>> library) throws IOException {
  ...
  public static List<String> viewXDayCrossOver(String symbol, String dateStr,
                                               int days, IAlphaAPIInterface api,
    ...
    try {
      ...
      if (stocks.size() < days) {
        throw new RuntimeException("Insufficient data points to calculate the " + days
                + "-day moving average.");
      }
