 ...
 * A Stock consists of various attributes like date,
...
public interface IStock {
   ...
   */
  static double viewGainLoss(String symbol, String startDateStr,
                             String endDateStr,
   ...
   */
  static double viewXDayMovingAverage(String symbol, String dateStr, int days,
   ...
   */
  static List<String> viewXDayCrossOver(String symbol, String dateStr, int days,
                                        IAlphaAPIInterface api, Map<String, List<Stock>> library)
          throws Exception {
