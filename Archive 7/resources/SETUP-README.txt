...
Also enter the date, which is the date that the portfolio is created on.

To add stocks to a portfolio on a different date, follow the instructions in the menu to add a
stock to an existing portfolio.
...
To view the composition or cost-basis of a program or plot the performance of a portfolio,
remember the name of your portfolio and type the corresponding number displayed in the menu.
