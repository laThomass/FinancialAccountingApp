NEW CHANGES FOR ASSIGNMENT 5:
    -Allowed shares to be fractional values.
    -Moving methods that should be in model from model to controller.
    -Fixed most if not all exception errors; program now moves more smoothly.
    -Added PortfolioDateList class and interface to model.
    -Abstracted start method.
    -Floated decimal values to 2 decimal places.
